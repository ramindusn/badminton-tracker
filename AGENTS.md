...
| 6.7 | **Hardcoded password (`shuttle2026` style)** in `AuthContext` for now, with `sessionStorage` flag | Pet-project scope; will be replaced by Supabase Auth in Phase 1. The value lives in `src/context/AuthContext.tsx`. |
